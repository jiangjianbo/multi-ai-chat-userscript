...
mainWindowController.addChatArea({ id: 'chat-area-1', providerName: 'ChatGPT', pinned: false, params: { webAccess: true, models: ['gpt', 'abc'] }});
mainWindowController.addChatArea({ id: 'chat-area-2', providerName: 'Gemini', pinned: true, params: { webAccess: false, models: ['gemini'] }, conversation: [{ type: 'question', content: 'abc' }, { type:'answer', content:'cdef'}]});
...
mainWindowController.renderChatAreas();
